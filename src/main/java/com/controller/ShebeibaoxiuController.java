...
public class ShebeibaoxiuController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,ShebeibaoxiuEntity shebeibaoxiu, HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("weixiushifu")) {
			shebeibaoxiu.setGonghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("xuesheng")) {
			shebeibaoxiu.setXuehao((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ShebeibaoxiuEntity shebeibaoxiu, HttpServletRequest request){
        EntityWrapper<ShebeibaoxiuEntity> ew = new EntityWrapper<ShebeibaoxiuEntity>();
		PageUtils page = shebeibaoxiuService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, shebeibaoxiu), params), params));
        return R.ok().put("data", page);
    }
