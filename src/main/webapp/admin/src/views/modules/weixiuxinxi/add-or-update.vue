  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="学生姓名" prop="xueshengxingming">
              <el-input v-model="ruleForm.xueshengxingming" 
                placeholder="学生姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="维修情况" prop="weixiuqingkuang">
          <el-select v-model="ruleForm.weixiuqingkuang" placeholder="请选择维修情况">
            <el-option
                v-for="(item,index) in weixiuqingkuangOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="维修情况" prop="weixiuqingkuang">
	      <el-input v-model="ruleForm.weixiuqingkuang"
                placeholder="维修情况" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                ...
                                                                                                this.weixiuqingkuangOptions = "已修好,已损坏".split(',')
                                                                                                                                        },
                                                                                        // 多级联动参数
                                                                                                                info(id) {
      this.$http({
