      ...
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                  ...
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.tushuguanmingcheng" placeholder="图书馆名称" clearable></el-input>
                                                                              ...
                                                                              <el-form-item :label="contents.inputTitle == 1 ? '自习室号' : ''">
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search" v-model="searchForm.zixishihao" placeholder="自习室号" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search" v-model="searchForm.zixishihao" placeholder="自习室号" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.zixishihao" placeholder="自习室号" clearable></el-input>
                </el-form-item>
                                                                                                                                      <el-form-item>
		    ...
		    label="容纳人数">
		     <template slot-scope="scope">
                ...
                <el-button v-if="isAuth('zixishi','查看') && contents.tableBtnIcon == 0" type="success" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">{{ contents.tableBtnFont == 1?'详情':'' }}</el-button>
                                                                <el-button v-if="isAuth('zixishi','预约') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="yuyuexinxiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'预约':'' }}</el-button>
                <el-button v-if="isAuth('zixishi','预约') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="yuyuexinxiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'预约':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('zixishi','预约') && contents.tableBtnIcon == 0" type="success" size="mini" @click="yuyuexinxiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'预约':'' }}</el-button>
      ...
      let params = {
        ...
        sort: 'id',
            ...
            params['tushuguanmingcheng'] = '%' + this.searchForm.tushuguanmingcheng + '%'
                                                            ...
                                                            if(this.searchForm.zixishihao!='' && this.searchForm.zixishihao!=undefined){
            params['zixishihao'] = '%' + this.searchForm.zixishihao + '%'
          }
                                                                                                                      this.$http({
        url: "zixishi/page",
        method: "get",
