          ...
          <el-form-item class="input" label="图书馆名称" prop="tushuguanmingcheng">
              <el-input v-model="ruleForm.tushuguanmingcheng" 
                placeholder="图书馆名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="自习室号" prop="zixishihao">
          <el-input v-model="ruleForm.zixishihao" 
              placeholder="自习室号" clearable  :readonly="ro.zixishihao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="自习室号" prop="zixishihao">
              <el-input v-model="ruleForm.zixishihao" 
                placeholder="自习室号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tushuguanmingcheng = true;
            continue;
	            	            ...
	            	            if(o=='zixishihao'){
            this.ruleForm.zixishihao = obj[o];
	    this.ro.zixishihao = true;
            continue;
          }
	            	            if(o=='tupian'){
