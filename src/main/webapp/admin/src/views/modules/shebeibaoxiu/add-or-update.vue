  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="师傅姓名" prop="shifuxingming">
              <el-input v-model="ruleForm.shifuxingming" 
                placeholder="师傅姓名" readonly></el-input>
                                                                  ...
                                                                  <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="保修日期" prop="baoxiuriqi">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.baoxiuriqi" label="保修日期" prop="baoxiuriqi">
              <el-input v-model="ruleForm.baoxiuriqi" 
                placeholder="保修日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="学生姓名" prop="xueshengxingming">
              <el-input v-model="ruleForm.xueshengxingming" 
                placeholder="学生姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="宿舍" prop="sushe">
          <el-input v-model="ruleForm.sushe" 
              placeholder="宿舍" clearable  :readonly="ro.sushe"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="宿舍" prop="sushe">
              <el-input v-model="ruleForm.sushe" 
                placeholder="宿舍" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
                                                                  <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="保修内容" prop="baoxiuneirong">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.baoxiuneirong" label="保修内容" prop="baoxiuneirong">
...
export default {
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                            ...
                                                            this.$http({
              url: `option/weixiushifu/gonghao`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
    ...
    gonghaoChange () {
      this.$http({
        url: `follow/weixiushifu/gonghao?columnValue=`+ this.ruleForm.gonghao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
                                                                                if(data.data.shifuxingming){
                this.ruleForm.shifuxingming = data.data.shifuxingming
              }
                                                                                                                                            } else {
          this.$message.error(data.msg);
        }
