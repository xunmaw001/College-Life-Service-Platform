  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(31, 147, 255, 0.83);fontSize:28px;">高校生活服务平台注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机" type="text" />
																								...
																								<!-- <div v-if="tableName=='weixiushifu'" class="input-group">
			   <div class="label">工号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.gonghao" class="input" type="text" placeholder="工号">
			   </div>
			 </div> -->
			<el-form-item label="工号" class="input" v-if="tableName=='weixiushifu'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='weixiushifu'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='weixiushifu'" class="input-group">
			   <div class="label">师傅姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.shifuxingming" class="input" type="text" placeholder="师傅姓名">
			   </div>
			 </div> -->
			<el-form-item label="师傅姓名" class="input" v-if="tableName=='weixiushifu'">
			  <el-input v-model="ruleForm.shifuxingming" autocomplete="off" placeholder="师傅姓名" type="text" />
			</el-form-item>
																														<!-- <div v-if="tableName=='weixiushifu'" class="input-group">
			...
			<el-form-item label="电话" class="input" v-if="tableName=='weixiushifu'">
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                  ...
                                                                  if((!this.ruleForm.gonghao) && `weixiushifu` == this.tableName){
        this.$message.error(`工号不能为空`);
        return
      }
                                                                  if((!this.ruleForm.mima) && `weixiushifu` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
                                                                                                                                                                                                                                                            if(`weixiushifu` == this.tableName && this.ruleForm.dianhua&&(!this.$validate.isMobile(this.ruleForm.dianhua))){
