     ...
     <el-row>
        ...
        <el-form-item   v-if="flag=='xuesheng'"  label="手机" prop="shouji">
          <el-input v-model="ruleForm.shouji"               placeholder="手机" clearable></el-input>
                                                ...
                                                <el-col :span="12">
        <el-form-item   v-if="flag=='weixiushifu'"  label="工号" prop="gonghao">
          <el-input v-model="ruleForm.gonghao" readonly              placeholder="工号" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        <el-form-item   v-if="flag=='weixiushifu'"  label="密码" prop="mima">
          <el-input v-model="ruleForm.mima"               placeholder="密码" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        <el-form-item   v-if="flag=='weixiushifu'"  label="师傅姓名" prop="shifuxingming">
          <el-input v-model="ruleForm.shifuxingming"               placeholder="师傅姓名" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        <el-form-item v-if="flag=='weixiushifu'"  label="性别" prop="xingbie">
          <el-select v-model="ruleForm.xingbie" placeholder="请选择性别">
            <el-option
                v-for="(item,index) in weixiushifuxingbieOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
                        ...
                        <el-col :span="24">  
        <el-form-item v-if="flag=='weixiushifu'" label="头像" prop="touxiang">
          <file-upload
          tip="点击上传头像"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.touxiang?ruleForm.touxiang:''"
          @change="weixiushifutouxiangUploadChange"
          ></file-upload>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        <el-form-item   v-if="flag=='weixiushifu'"  label="电话" prop="dianhua">
      ...
      if (data && data.code === 0) {
        ...
        this.$message.error(data.msg);
                                            ...
                                            this.xueshengxingbieOptions = "男,女".split(',')
                                                                        this.weixiushifuxingbieOptions = "男,女".split(',')
                                                                                                                                  },
  methods: {
                                                                                                                                                                                                                                                                                        xueshengtouxiangUploadChange(fileUrls) {
        this.ruleForm.touxiang = fileUrls;
    },
                                                                        weixiushifutouxiangUploadChange(fileUrls) {
        this.ruleForm.touxiang = fileUrls;
    },
                                                                                                                            onUpdateHandler() {
        ...
        return
                                                                  ...
                                                                  if((!this.ruleForm.gonghao)&& 'weixiushifu'==this.flag){
        this.$message.error('工号不能为空');
        return
      }
                                                                  if((!this.ruleForm.mima)&& 'weixiushifu'==this.flag){
        this.$message.error('密码不能为空');
        return
      }
                                                                                                                                                                                                                                                            if( 'weixiushifu' ==this.flag && this.ruleForm.dianhua&&(!isMobile(this.ruleForm.dianhua))){
